...
| ---------| ------------------- | ------------ |
| Upload Daten | Die Daten werden hochgeladen und sind im Explorer ersichtlich | Alle Daten wurden hochgeladen und es wurden noch weitere über den upload hinzugefügt:![Fileupload](Pictures/Fileupload.png) |
